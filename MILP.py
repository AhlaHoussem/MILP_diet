...
def main():
    ...
    prob += 4*x1 + 0*x2 + 14.5*x3 + 0*x4 + 45*x5 + 0*x6 >= 1000
    prob += 2*x1 + 26*x2 + 0.7*x3 + 25*x4 + 15*x5 + 22*x6 >= 105
    prob += 0.3*x1+17*x2+0.3*x3+21*x4+1*x5+13*x6 <= 200
    prob += 30*x1 + 250*x2 +57* x3 +335* x4 +245* x5 +206* x6 <= 3000
